...
<div class="page-wrapper">
    <div class="page-content">
        <!--breadcrumb-->
        @include('layouts.breadcrumb', ['menu'=> 'Prestations', 'path'=> 'prestations'])
        <!--end breadcrumb-->
        <div class="card">
            <div class="card-body">
                <h4 class="mb-0">Liste des prestations</h4>
                            ...
                            <table id="example2" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($prestations as $prestation )
                                        <tr>
                                            <td>{{ $prestation->r_code }}</td>
                                            <td>{{ $prestation->r_libelle }}</td>
                                            <td>{{ $prestation->r_prix }}</td>
                                            <td>{{ $prestation->created_at->format('d.m.Y à H:i:s') }}</td>
                                            <td>
                                                <i class="bx bx-edit text-primary icons edit" title="Modification de la catégorie {{ $prestation->r_libelle }}" data-id="{{ $prestation }}"></i>
                                                <i class="bx bx-trash text-danger icons delete" title="Supression de la catégorie {{ $prestation->r_libelle }}" data-id="{{ $prestation }}" ></i>
                                            </td>
                                        </tr>
                                    @endforeach
