...
use App\Http\Controllers\Personnels\CategoriesController;
use App\Http\Controllers\Personnels\PersonnelsController;
use App\Http\Controllers\Personnels\SpecialitesController;
use App\Http\Controllers\Prestations\ActesMedicauxController;
use App\Http\Controllers\Prestations\PrestationsController;
use App\Http\Controllers\Prestations\TypeActeController;
...
Route::resources([
    ...
    'specialites' => SpecialitesController::class,
    'personnels' => PersonnelsController::class,

    //Actes médicaux et prestations
    'types_actes_medicaux' => TypeActeController::class,
    'actesmedicaux' => ActesMedicauxController::class,
    'prestations' => PrestationsController::class,
]);
